...
import com.nourri.busticketing.client.WhatsAppApiClient;
import com.nourri.busticketing.dto.RenderableTicket;
import com.nourri.busticketing.util.TicketFormatter;
    ...
    public void sendAllTickets(String toPhone, List<RenderableTicket> tickets) {
        ...
        if (seatsChosen) {
            List<String> allSeats = tickets.stream()
                ...
                .toList();
            seatOverlayBase64 = imageOverlayService.createImageWithHighlights(allSeats);
        }
